...
#    "人工智能", "Anthropic", "AI", "谷歌", "google", "苹果", "英伟达",
#    "微软", "谷歌", "Google", "苹果", "Apple", "亚马逊", "Amazon",
#    "Meta", "脸书", "英伟达", "Nvidia", "英特尔", "Intel",
#    "AMD", "台积电", "TSMC","云服务", "互联网", "科技",

    # 半导体 / 芯片
#    "半导体", "芯片", "存储", "GPU", "CPU", 

    # 机器人 / 自动驾驶
#    "机器人", "自动驾驶", "无人驾驶", "无人机", "电动车", "新能源", "充电桩",
...
FINANCE_KEYWORDS = [
    "北京", "上海", 
    # 宏观经济
#    "经济", "GDP", "通胀", "通缩", "就业", "失业率", "非农", "消费者价格指数", "CPI", "PPI", "PMI", "衰退"
#    "经济", 

    # 央行 / 利率 / 货币政策
    
#    "美联储", "沃什", "央行", "量化宽松", "缩表", 利率", "降息", "加息", 
